...
class VirtualObjectInteraction: NSObject, UIGestureRecognizerDelegate {
    ...
    let viewController: ARScreenViewInterface
    ...
    init(sceneView: VirtualObjectARView, viewController: ARScreenViewController) {
    ...
    */
    ...
    func setDown(_ object: VirtualObject, basedOn screenPos: CGPoint) {
        ...
        if let query = sceneView.raycastQuery(from: screenPos,
                                              allowing: .estimatedPlane,
                                              alignment: object.allowedAlignment),
            let raycast = viewController.createTrackedRaycastAndSet3DPosition(of: object,
                                                                              from: query,
                                                                              withInitialResult: nil) {
